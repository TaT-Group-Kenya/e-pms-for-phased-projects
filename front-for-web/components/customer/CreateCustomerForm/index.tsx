...
const customerSchema = z.object({
  name: z.string().min(1, "Customer name is required").min(3, "Customer name must be at least 3 characters"),
...
const CreateCustomerForm: React.FC = () => {
  ...
  const onSubmit = async (data: CustomerFormData) => {
    ...
    try {
      ...
      setFormError("An error occurred while creating the customer");
    } finally {
      setIsSubmitting(false);
    }
  };

  const renderFieldError = (fieldName: keyof CustomerFormData) => {

...
const Sidebar: React.FC = () => {
  return (
    <aside className="w-64 bg-card dark:bg-primary-dark border-r border-gray-100 dark:border-gray-800 h-screen sticky top-0">
      <div className="p-6">
        <Link href="/dashboard" className="text-xl font-bold text-primary">e-PMS</Link>
      </div>

      <nav className="px-4 py-2 text-sm text-muted">
        <ul className="space-y-1">
          <li>
            <Link href="/dashboard" className="flex items-center p-3 rounded hover:bg-gray-50 dark:hover:bg-gray-800">Dashboard</Link>
          </li>
          <li>

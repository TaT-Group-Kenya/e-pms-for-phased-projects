...
const RecentOrders: React.FC<RecentOrdersProps> = ({ value }) => {
      ...
      <div className="bg-purple-50 dark:bg-[#15203c] rounded-md py-[22px] px-[20px]">
        <div className="flex items-center">
          <div className="text-purple-500 leading-none ltr:mr-[10px] rtl:ml-[10px]">
            <i className="material-symbols-outlined !text-5xl">shopping_cart</i>
          </div>
          <div>
            <span className="block">Recent Orders</span>

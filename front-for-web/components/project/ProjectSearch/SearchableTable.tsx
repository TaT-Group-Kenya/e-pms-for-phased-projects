...
const SearchableTable: React.FC = () => {
  ...
  const [showPopup, setShowPopup] = useState(false); // Control add-new popup visibility
              ...
              <tbody className="text-black dark:text-white">
                {usersToDisplay.map((user) => (
                  <tr key={user.id}>
                    ...
                    <td className="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                      <span
                        className={`px-[8px] py-[3px] inline-block dark:bg-[#15203c] rounded-sm font-medium text-xs ${user.status === "Active"
              ...
              {Array.from({ length: totalPages }, (_, index) => (
                ...
                >
                  <button
                    ...
                    className={`w-[31px] h-[31px] block leading-[29px] relative text-center rounded-md border border-gray-100 dark:border-[#172036] transition-all hover:bg-primary-500 hover:text-white hover:border-primary-500 ${currentPage === index + 1

...
<head>
    <meta charset="UTF-8">
    <title>Company Credit Note {{ $creditNote->credit_note_number }}</title>
    <style>
...
<body>
    ...
    <div class="section two-col" style="gap: 40px;">
        <div class="card" style="min-width: 260px;">
            ...
            <div class="summary-row"><span class="summary-label">Status:</span> {{ ucfirst($creditNote->status) }}</div>
            ...
            @if($creditNote->invoice && $creditNote->invoice->company)
                <div class="summary-row"><span class="summary-label">Company:</span> {{ $creditNote->invoice->company->name }}</div>
            @endif
        </div>
        <div class="card" style="min-width: 260px; margin-top: 25;">
            <h2>Invoice</h2>
    ...
    <div class="footer">
        Generated at {{ $generatedAt ?? now() }} | Powered by EPMS
    </div>
</body>
</html>

    ...
    <div class="header">
        <div style="text-align: right;">
            ...
            <div class="muted">Date:
                {{ optional($transaction->transaction_date ?? $transaction->created_at)->format('d/m/Y') }}
            </div>
    ...
    <div class="section two-col">
        ...
        <div class="card" style="flex: 1;">
            ...
            <div class="row">
                ...
                <div class="value">
                    {{ optional($transaction->paymentMethod)->name ?? $transaction->payment_method ?? '-' }}</div>
            </div>
            <div class="row">
    ...
    <div class="section two-col">
        <div class="card" style="flex: 1;">
            ...
            <div class="row mt-1">
                ...
                <div class="value">{{ $transaction->source_type ?? '-' }} @if($transaction->source_id)
                #{{ $transaction->source_id }} @endif</div>
            </div>
            <div class="row">
    ...
    <div class="section card">
        ...
        <div class="text-sm">
            ...
            @if(!empty($senderCity) || !empty($senderState) || !empty($senderCountry))
                {{ trim(($senderCity ?? '') . (isset($senderCity, $senderState) ? ', ' : '') . ($senderState ?? '')) }}@if(!empty($senderCountry)),
                {{ $senderCountry }}@endif<br>
            @endif

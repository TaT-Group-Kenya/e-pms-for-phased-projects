...
class AuthServiceProvider extends ServiceProvider
{
    ...
    protected $policies = [
        ...
        \App\Models\CompanyCreditNoteTaxItem::class => CompanyCreditNoteTaxItemPolicy::class,
        ...
        \App\Models\CompanyInvoiceTaxItem::class => CompanyInvoiceTaxItemPolicy::class,
        ...
        \App\Models\CustCreditNoteTaxItem::class => CustCreditNoteTaxItemPolicy::class,
        ...
        \App\Models\OrderTaxItem::class => OrderTaxItemPolicy::class,
        ...
        \App\Models\QuotationTaxItem::class => QuotationTaxItemPolicy::class,

...
class CompanyTransactionsLedgerStoreRequest extends FormRequest
{
    ...
    {
        return [
            'company_payment_id' => ['required', 'exists:company_payments,id'],
            'transaction_number' => ['required', 'string', 'max:255', Rule::unique('company_transactions_ledger')],

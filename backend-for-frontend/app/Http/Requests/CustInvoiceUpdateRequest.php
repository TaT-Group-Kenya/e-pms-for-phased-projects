...
class CustInvoiceUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'invoice_number' => ['sometimes', 'required', 'string', 'max:255', Rule::unique('cust_invoices')->ignore(
                    $this->route('cust_invoice')
                )],
            ...
            'status' => ['sometimes', 'required', Rule::in(['draft','sent','paid','partial-paid'])],

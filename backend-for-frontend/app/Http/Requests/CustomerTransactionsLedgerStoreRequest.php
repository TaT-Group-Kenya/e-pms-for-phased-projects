...
class CustomerTransactionsLedgerStoreRequest extends FormRequest
{
    ...
    {
        return [
            'cust_payment_id' => ['required', 'exists:cust_payments,id'],
            'transaction_number' => ['required', 'string', 'max:255', Rule::unique('customer_transactions_ledger')],

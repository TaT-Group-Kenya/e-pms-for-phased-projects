...
class CustInvoiceItemService
{
    ...
    {
        return CustInvoiceItem::create($data);
    }

    public function update(int $id, array $data)
    {
        $model = CustInvoiceItem::findOrFail($id);
        $model->update($data);
        return $model;
    }
    ...
    {
        return CustInvoiceItem::destroy($id);
    }
}